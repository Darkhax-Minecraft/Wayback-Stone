...
dependencies {
     // NeoForge
     implementation group: 'net.darkhax.waybackstone', name: 'waybackstone-neoforge-26.1.2', version: '26.1.2.0'
     // Fabric
     implementation group: 'net.darkhax.waybackstone', name: 'waybackstone-fabric-26.1.2', version: '26.1.2.0'
     // Common / MultiLoader / Vanilla / No Loader
     implementation group: 'net.darkhax.waybackstone', name: 'waybackstone-common-26.1.2', version: '26.1.2.0'
}
```
